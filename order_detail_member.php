...
<body>
	<div class="container_24">
		...
		<div class="grid_9 top_menu">
			<a href="order_detail_member.php" id="tab_cart">KERANJANG<div class="cart"></div></a>
        			...
        			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="viewer">
					  ...
					  if (isset($_SESSION['items'])) {
					        foreach ($_SESSION['items'] as $key => $val){
					            $query = mysql_query ("select produk.id, produk.nama, produk.harga from produk where produk.id = '$key'");
					  ...
					  <tr>
					    ...
					    <td align="right"><a href="cart.php?act=plus&amp;produk_id=<?php echo $key; ?>&amp;ref=order_detail_member.php">+</a> | <a href="cart.php?act=min&amp;produk_id=<?php echo $key; ?>&amp;ref=order_detail_member.php">-</a> | <a href="cart.php?act=del&amp;produk_id=<?php echo $key; ?>&amp;ref=order_detail_member.php">Hapus</a></td>
					  </tr>
					  <?php
