...
<body>
	<div class="container_24">
		...
		<div class="grid_9 top_menu">
			...
			<a href="akun_member.php" id="tab_account">AKUN</a>
    ...
    <div class="container_24 margin_top30">
      ...
      <div class="produk_tengah">
      	<div class="text_tengah"
   			<span style="font-size: 12px;"><strong>Proses Pengiriman Barang</strong><br />
		  	<p>Pengiriman barang akan dilakukan setelah order diproses dan pembeli melakukan konfirmasi transfer dana<br/><br/>
		    Kami menggunakan jasa JNE dan pengiriman tidak dikenakan biasa untuk wilayah Indonesia saja. No resi pengiriman akan kami kirim lewat email atau langsung mengirim sms kepada pembeli supaya barang bisa dilacak</p>
  		</div>
	    <div class="buttons">
	      <table>
	        <tr>
