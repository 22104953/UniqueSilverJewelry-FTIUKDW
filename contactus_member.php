  ...
  if ( !empty($_POST['kirim']) )
    {
      ...
      if (mysql_query($query)) 
        header("location:terimakasih_member.php");
      } 
    }
?>
              ...
              <b>email</b><br />uniquesilverjewelry@yahoo.com                     
	    			...
	    			<table>
				      <tr>
				        <td>Nama</td>
				        <td>:</td>
				        <td><input type="text" name="nama" size="35"> <?php if (isset($error_nama)) echo "data tidak boleh kosong";?></td>
				      </tr>
				      <tr>
				        <td>E-mail</td>
				        <td>:</td>
				        <td><input type="text" name="email" size="35"> <?php if (isset($error_email)) echo "data tidak boleh kosong";?> </td>
				      </tr>
				      <tr>
	        			<td>Pesan</td>
	      				<td>:</td>
	        			<td><textarea name="pesan" rows="5" cols="50"></textarea><?php if (isset($error_pesan)) echo "data tidak boleh kosong";?></td>
	      			  </tr>
	    			</table>
