        		...
        		<div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px;">
        			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="viewer">
					  ...
					  <tr>
					    ...
					    <td align="right"><a href="cart.php?act=plus&amp;produk_id=<?php echo $key; ?>&amp;ref=order_detail.php">+</a> | <a href="cart.php?act=min&amp;produk_id=<?php echo $key; ?>&amp;ref=order_detail.php">-</a> | <a href="cart.php?act=del&amp;produk_id=<?php echo $key; ?>&amp;ref=order_detail.php">Hapus</a></td>
					  </tr>
					  <?php
					  ...
					  <tr>
					    ...
					    <td align="right"><a href="cart.php?act=clear&amp;ref=order_detail.php">Clear</a></td>
					  </tr>
					</table>
