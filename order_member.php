...
<body>
	<div class="container_24">
		<div class="grid_8">
			<a href="index_member.php"><img src="image/data/logo/logo.gif" title="Unique Silver Jewelry" alt="Unique Silver Jewelry" /></a>
		</div>
		<div class="grid_5 margin_top30 prefix_2">
			<img src="style/css/image/shipping.png"/>
		</div>
		<div class="grid_9 top_menu">
			<a href="keranjang_member.php" id="tab_cart">KERANJANG<div class="cart"></div></a>
			<a href="login_member.php" id="tab_account">AKUN</a>
			<a href="index.php" id="tab_daftar">LOGOUT</a>
    	</div>
    	...
    	<div class="grid_22 prefix_2 navigasi">
    		<a href="index_member.php">BERANDA</a>
    		<a href="aboutus_member.php">TENTANG KAMI</a>
    		<a href="contactus_member.php">HUBUNGI KAMI</a>
    		<a href="order_member.php">INFO ORDER</a>
    		<a href="shipping_member.php">INFO PENGIRIMAN</a>
    	</div>
    	<div class="clear"></div>
    </div>
    ...
    <div class="container_24 margin_top30">
    				...
    				<td>
    					<table cellpadding="3" cellspacing="0" style="width: 100%;">
	    					<tr>
	          				...
	          				<tr>
				            	<td valign="top" width="1"><a href="layout_member.php?kategori=gelang"><img src="image/data/chace/gl.jpg" alt="Gelang" /></a></td>
				            	<td align="left"><a href="layout_member.php?kategori=gelang">Gelang</a>
	          				</tr>
				         	<tr>
				            	<td valign="top" width="1"><a href="layout_member.php?kategori=anting"><img src="image/data/chace/ant.jpg" alt="Anting" /></a></td>
				            	<td align="left"><a href="layout_member.php?kategori=anting">Anting</a>
				         	</tr>
			          		<tr>
			            		<td valign="top" width="1"><a href="layout_member.php?kategori=kalung"><img src="image/data/chace/kl.jpg" alt="Kalung" /></a></td>
			            		<td align="left"><a href="layout_member.php?kategori=kalung">Kalung</a>
			          		</tr>
			          		<tr>
				            	<td valign="top" width="1"><a href="layout_member.php?kategori=cincin"><img src="image/data/chace/cn.jpg" alt="cincin" /></a></td>
				            	<td align="left"><a href="layout_member.php?kategori=cincin">Cincin</a>
			          		</tr>
	          			</table>
	          		</td>
	          	</tr>
    			...
    			<tr>
    				<td>
    					<table cellpadding="3" cellspacing="0" style="width: 100%;">
	    					...
	    					<tr>
              					<td valign="top" width="1"><a href="produk_detail_member.php?kode=AN0001"><img src="image/data/chace/AN0001.jpg"/></a></td>
              					<td valign="center"><a href="produk_detail_member.php?kode=AN0001"><span style="font-size: 11px;">Rectanglular Pave</span></a>
                    			<br />
      ...
      <div class="produk_tengah">
      	<div class="text_tengah"
   			<span style="font-size: 12px;"><strong>Cara mudah berbelanja di Unique Silver</strong><br/>
		    <ol>
		      <li>Pilih kategori produk yang tersedia.</li>
		      <li>Pilih produk yang akan dibeli.</li>
		      <li>Klik pada produk (foto atau nama).</li>
		      <li>Kemudian pada detail produk klik Tambahkan ke Keranjang.</li>
		      <li>Order akan masuk ke keranjang dan keranjang update sesuai jumlah order.</li>
		      <li>Untuk melihat produk yang ada di keranjang, klik Keranjang yang ada di pojok kanan atas atau melalui tombol di dalam kotak Keranjang.</li>
		      <li>Di dalam keranjang dapat melihat produk yang sudah dipilih. Anda bisa melanjutkan belanja dengan mengklik lanjutkan belanja atau anda bisa langsung melaksanakan proses pembayaran dengan mengklik Akhiri Belanja.</li>
		      <li>Apabila anda belum memiliki akun, silahkan memilih Daftar Akun. Jika anda sudah memiliki akun silahkan login dengan akun anda.</li>
		      <li>Pilih metode pengiriman (pengiriman gratis atau COD).</li>
		      <li>Apabila anda merasa sudah siap, silahkan klik Konfirmasi Order.</li>
		      <li>Selesai.</li>
		    </ol>
  		</div>
	    <div class="buttons">
	      <table>
	        <tr>
	          <td align="right"><a href="index_member.php" class="button"><span>Lanjut</span></a></td>
	        </tr>
	      </table>
	    </div>
	  </div>
    ...
    Copyright &copy; 2013 <a href="index_member.php" target="_blank" alt="Unique Silver Jewelry" title="Unique Silver Jewelry">Unique Silver Jewelry</a><br />
</body>
</html> 