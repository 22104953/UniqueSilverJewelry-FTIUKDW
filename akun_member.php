	  ...
	  <div id="content">
	      ...
	      <div class="produk_tengah">
	      	<div class="text_tengah">
	   			<div style="display: inline-block; width: 555px"><b style="margin-bottom: 2px; display: block;">Telah Memiliki Akun</b>
        		<div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px;">
				      ...
				      {
				        $err = 1;
				        echo "<b>Email dan Password yang anda masukan salah</b>";
				    ?>
				    <?php }?>
		  		</div>
		   </div>
